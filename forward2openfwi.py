...
def forward2all():
    ...
    start_id = 40000
    path = r".\data\CurveFaultA"
    output_dir = r".\data\temporary_storage"
    pro_pool_set = [7]
    ...
    start_outid, start_inid = id_single2batch(start_id, 500)

    for vmodel_dir in vmodel_dir_list:

        cur_outid = int(re.findall(r'\d+', vmodel_dir)[0])
        ...
        while cur_inid < 500:
            ...
            vmodel_id = id_batch2single(cur_outid, cur_inid, 500)
...
if __name__ == '__main__':
    ...
    # data_pack(dir=r".\data\temporary_storage",
    #           keyword="single_seismic",
    #           pack_size=500,
    #           para_range=[48000, 54000],
    #           save_dir=r".\data\CurveVelA",
